...
function SheetContent({
  ...
  /** Open above another sheet without dismissing it. */
  stacked?: boolean
}) {
  return (
    <SheetPortal>
      <SheetOverlay className={stacked ? "z-[60]" : undefined} />
      ...
      >
        {/* min-h-0 lets this flex child shrink below its content height
            so it can scroll once the sheet hits max-h. Do NOT add flex-1:
            with h-auto that sets flex-basis 0 and collapses the sheet. */}
