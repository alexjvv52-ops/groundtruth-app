# Still open
Named rather than hidden. This is the honest floor as of release 0.1.2
(2026-09-16). Each item says what would close it. None of them is a
second product philosophy; they are packaging, reach, and scope.
## Open
| Item | State | What closes it |
|------|-------|----------------|
| Public installer pack | Closed. Unsigned Windows installers are published on the Releases page (v0.1.0, 0.1.1, 0.1.2), each with the SHA-256 GitHub shows under the asset. | Code-signing, if it ever earns its yearly cost. SmartScreen warns until then. |
